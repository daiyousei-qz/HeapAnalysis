...
define dso_local void @foo(i32* %ptr, i32 %x, i32 %y) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @buz(i32 %x, i32 %y) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [3 x i32*], [3 x i32*]* %p, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  %arrayidx1 = getelementptr inbounds [3 x i32*], [3 x i32*]* %p, i64 0, i64 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @sumUpTo(i32 %n) #0 {
entry:

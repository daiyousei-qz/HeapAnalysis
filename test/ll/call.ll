...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @do_swap_once(i32* %a, i32* %b) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @do_swap_twice(i32* %a, i32* %b) #0 {
entry:
  %a.addr = alloca i32*, align 8
  %b.addr = alloca i32*, align 8
  store i32* %a, i32** %a.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @do_swap_alias(i32* %a, i32* %b) #0 {
entry:
  %a.addr = alloca i32*, align 8
  %b.addr = alloca i32*, align 8
  store i32* %a, i32** %a.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32* @alloc_int(i32 %value) #0 {
entry:
...
entry:
  ...
  store i32** %p, i32*** %p.addr, align 8
  store i32** %q, i32*** %q.addr, align 8
  %call = call i32* @alloc_int(i32 1)
  %0 = load i32**, i32*** %p.addr, align 8
  store i32* %call, i32** %0, align 8
  %call1 = call i32* @alloc_int(i32 41)
  %1 = load i32**, i32*** %q.addr, align 8
  store i32* %call1, i32** %1, align 8

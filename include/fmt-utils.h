...
namespace fmt
{
    template <> struct formatter<LocationTag> : formatter<std::string_view> {
        ...
        auto format(LocationTag c, FormatContext& ctx) {
            ...
            switch (c) {
            case LocationTag::Register:     name = "Register"; break;
            case LocationTag::Dynamic:      name = "Dynamic"; break;
            case LocationTag::Value:        name = "Value"; break;
            case LocationTag::StackAlloc:   name = "StackAlloc"; break;
            case LocationTag::HeapAlloc:    name = "HeapAlloc"; break;
            }

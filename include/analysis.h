...
/**
 * Summary information generated by analysis that depict observable point-to graph from callers
 */
...
public:
    std::unordered_map<const llvm::BasicBlock*, std::unordered_set<const llvm::BasicBlock*>>
        block_src_map_;

    std::unordered_map<const llvm::BasicBlock*, std::vector<const llvm::StoreInst*>>
        block_store_cache_;
